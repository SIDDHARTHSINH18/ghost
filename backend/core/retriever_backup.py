...
class DocumentRetriever:
    ...
    def __init__(
        ...
        # It is loaded once when the retriever starts.
    ...
    def retrieve(
        ...
        # -------------------------------------------------
        # 4. Remove completely irrelevant chunks
        # -------------------------------------------------
        ...
        # -------------------------------------------------
        # 5. Select strongest matches
        # -------------------------------------------------

        selected = relevant_chunks[:self.top_k]
